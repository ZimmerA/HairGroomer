...
void MvpPresenter::exportHair(QFile* file)
{
    ...
    hairFile << "    <array name=\"boneSpheres\" size=\"\" type=\"Struct\" structElements=\"boneSphereIndex(I32),boneSphereRadius(F32),boneSphereLocalPos(Vec3)\">\n"; // TODO: size
    ...
    hairFile << "    <array name=\"pinConstraints\" size=\"0\" type=\"Struct\" structElements=\"boneSphereIndex(I32),boneSphereRadius(F32),boneSphereLocalPos(Vec3),pinStiffness(F32),influenceFallOff(F32),useDynamicPin(Bool),doLra(Bool),useStiffnessPin(Bool),influenceFallOffCurve(Vec4)\"></array>\n";
    ...
    for(int i = 0; i < 4; ++i)
    {
        ...
        hairFile << "        <value name=\"rootColor\" type=\"Vec4\">0.0509803928 0.0156862754 0.0156862754 1</value>\n";
        ...
        hairFile << "        <value name=\"specularColor\" type=\"Vec4\">0.400000006 0.443137258 0.474509805 1</value>\n";
        ...
        hairFile << "        <value name=\"bendStiffnessCurve\" type=\"Vec4\">1 0.910256386 0.75999999 0.217948735</value>\n";
